"use client";
import { ArrowLeft, Eye, Github, Mail, Phone, Twitter } from "lucide-react";
			...
			>
				<div className="container flex flex-row-reverse items-center justify-between p-6 mx-auto">
					<div className="flex justify-between gap-8">
						...
						<Link target="_blank" href="mailto:futurussjt@outlook.es">
							<Mail
						...
						<Link target="_blank" href="https://futurussjt.vercel.app/contact">
							<Phone
								className={`w-6 h-6 duration-200 hover:font-medium ${isIntersecting
									? " text-zinc-400 hover:text-zinc-100"
									: "text-zinc-600 hover:text-zinc-900"
